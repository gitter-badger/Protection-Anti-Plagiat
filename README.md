...
* protectionantiplagiat v1.8 // Optimisation de la function get_ip_address() + insertion d'une function validate_ip($ip)
* protectionantiplagiat v1.9 // Ajout de la fonction $hostname = gethostbyaddr($_SERVER['REMOTE_ADDR']);
